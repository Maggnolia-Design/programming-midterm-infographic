...
function setup() {
  ...
  fill("#999");
  textFont(fontHeader);
  text("CHALLENGING PREJUDICE", 110, 85, 600, 200);
  ...
  // textFont(fontBody);
  text(
    "Is there a coorelation between literacy rates and IQ?",
    740,
    87,
    400,
    200
  ...
  textSize(17);
  fill("#66f");
  text("IQ Level", 770, 257, 500, 200);
  rect(750, 260, 10, 8);
  fill("#f66");
  text("Literacy Rate", 770, 232, 500, 200);
  rect(750, 235, 10, 8);
  ...
  text(
    "HK / BR / GN  /  FI /   FJ  / GR /  NL / NG  / CO",
    535,
    760,
    1000,
    200
  );
  text("NZ / NP  / EG /  GT / CN", 893, 760, 1000, 200);
  text(
    "GQ  / IQ /  CA  /  IR  /  IT /  EC /  CD    CZ    AR / AU  /  IL  / IN  /\tLB /   IE /   ID /  CU / GH",
    1090,
    760,
    1000,
    200
  );
  text("/ MA    KE  / JM / MN   MH   KR    MY / MX / AT", 1760, 760, 1000, 200);
}
